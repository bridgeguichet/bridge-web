...
import { Invoice01Icon, ShoppingBag01Icon } from "@hugeicons/core-free-icons";
...
export default function SingleOrdersPage() {
  const { data: orders = [], isLoading } = useOrders({ type: "single" });

  return (
    <div className="space-y-6">
      {/*<motion.div initial={{ opacity: 0, y: -20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
        <h1 className="text-4xl font-black text-gray-900 md:text-5xl">Mes commandes</h1>
        <p className="mt-2 text-lg text-gray-600">Suivez l&apos;état de vos commandes uniques</p>
      </motion.div>*/}
      <motion.div
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-muted-foreground">
                Suivez l&apos;état de vos commandes uniques
              </p>
            </div>
          </div>
        </motion.div>
