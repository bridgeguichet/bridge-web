...
import { useService, useServiceVariants, useServices } from "@/features/marketplace/hooks";
...
export default function ServiceDetailPage() {
  ...
  const displayPrice = selectedVariantData?.price || service.basePrice;

  const similarServices = allServices?.filter((s: ServiceWithDetails) => s.id !== service.id && s.categoryId === service.categoryId).slice(0, 4);
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            >
              ...
              <div className="absolute bottom-0 left-0 right-0 p-8">
                ...
                <h1 className="text-3xl md:text-4xl font-black text-white mb-2">{service.nameFr}</h1>
            ...
            >
              <div className="flex items-start justify-between">
                <div className="flex items-center gap-4">
                  <div className={cn("w-16 h-16 rounded-full flex items-center justify-center", avatarColor)}>
              ...
              <Tabs defaultValue="description" className="w-full">
                ...
                <TabsContent value="description" className="p-6 mt-0">
                  <div className="prose max-w-none">
                    ...
                    <h4 className="font-bold text-lg mt-6 mb-3">Ce qui est inclus</h4>
                        ...
                        >
                          <div className="flex items-center justify-between">
                            <div className="flex items-center gap-3">
                              ...
                              >
                                {selectedVariant === variant.id && <div className="w-2.5 h-2.5 rounded-full bg-primary" />}
                              </div>
                              <div>
                ...
                <TabsContent value="reviews" className="p-6 mt-0">
                  <div className="space-y-6">
                          ...
                          <div key={star} className="flex items-center gap-3">
                            ...
                            <div className="flex-1 h-2 bg-gray-200 rounded-full overflow-hidden">
                              <div
                                ...
                                style={{ width: `${star === 5 ? 75 : star === 4 ? 15 : 10}%` }}
                              />
                            </div>
                    ...
                    <div className="space-y-4">
                      {[
                        { name: "Marie K.", rating: 5, date: "Il y a 2 jours", comment: "Excellent service ! Je recommande vivement." },
                        { name: "Jean P.", rating: 5, date: "Il y a 1 semaine", comment: "Très professionnel et rapide." },
                        { name: "Sophie M.", rating: 4, date: "Il y a 2 semaines", comment: "Bon service, légèrement cher mais qualité au rendez-vous." },
                      ].map((review, i) => (
            ...
            >
              <div className="flex items-start justify-between mb-6">
                ...
                <button
                  ...
                  aria-label="Favori"
                >
                  <Heart className={cn("w-5 h-5", liked ? "fill-rose-500 text-rose-500" : "text-gray-400")} />
                </button>
              </div>
              ...
              <Button onClick={handleAddToCart} className="w-full mb-3 gap-2" size="lg">
              ...
              <p className="text-xs text-center text-gray-500 mt-4">Aucun frais de réservation. Annulation gratuite 24h avant.</p>
            </motion.div>
          </div>
        </div>
