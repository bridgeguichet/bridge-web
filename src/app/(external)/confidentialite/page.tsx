...
import { AlertCircle, AlertTriangle, Clock, Database, FileText, Lock, Share2, Shield, UserCheck } from "lucide-react";
    ...
    <div className="min-h-screen bg-background">
      <section className="relative bg-secondary py-20 text-white md:py-24">
        <div className="container mx-auto max-w-4xl px-6 text-center">
          ...
          <h1 className="mb-6 font-[batangas] text-4xl font-bold md:text-6xl">{t("confidentialitePage.heroTitle")}</h1>
      ...
      <section className="bg-white py-16 md:py-20">
        <div className="container mx-auto max-w-4xl px-6">
          <nav className="mb-12 rounded-2xl border border-border bg-muted/30 p-6">
            <h2 className="mb-4 text-lg font-semibold text-foreground">{t("confidentialitePage.tableOfContents")}</h2>
          ...
          <div className="mt-16 rounded-2xl border border-border bg-muted/30 p-8">
            <h3 className="mb-4 text-xl font-semibold text-foreground">{t("confidentialitePage.contact.title")}</h3>
            <p className="mb-4 text-muted-foreground">{t("confidentialitePage.contact.description")}</p>
            <div className="space-y-2 text-sm">
              ...
              <p className="text-muted-foreground">
                <strong className="text-foreground">{t("confidentialitePage.contact.address")}:</strong>{" "}
