      ...
      <div className="container mx-auto px-6 py-12 lg:px-8">
        {confirmed ? (
          ...
          >
            ...
            <p className="mb-2 text-gray-500">Votre rendez-vous avec un conseiller Bridge a bien été enregistré.</p>
            {appointment.date && appointment.timeSlot && (
              <div className="my-6 rounded-2xl border border-gray-200 bg-white p-6 text-left shadow-sm">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <div>
                    <p className="font-semibold text-gray-900 capitalize">{formatAppointmentDate(appointment.date)}</p>
          ...
          >
            ...
            <div className="flex justify-end">
              <Button size="lg" disabled={!isComplete} onClick={handleConfirm} className="gap-2 px-8">
