...
import { Building2, Server, Copyright, Info } from "lucide-react";
  ...
  const renderSectionContent = (sectionId: string) => {
    ...
    return (
      <div className="space-y-4">
        ...
        {section.company && (
          <p className="font-semibold text-foreground text-lg">{section.company}</p>
        )}
        ...
        <div className="container mx-auto max-w-4xl px-6">
          ...
          <div className="mt-16 rounded-2xl border border-border bg-muted/30 p-8">
            <h3 className="mb-4 text-xl font-semibold text-foreground">
              {t("mentionPage.contact.title")}
            </h3>
            <p className="mb-4 text-muted-foreground">
              {t("mentionPage.contact.description")}
            </p>
