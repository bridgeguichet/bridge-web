...
const mockTestimonials = [
  {
    id: "1",
    name: "Austin Theory",
    role: "Entrepreneur, Fondateur - SiteKrafter, Filmora",
    text: "Great products, great company. The support from BdThemes is fantastic. After having issues with the Elementor Pro Pack one of their support agents got in touch very quickly to resolve my issue. Their products are top notch, one of the best providers for WordPress.",
    imageUrl: "/media/image-diaspora.jpg",
    videoUrl: null,
    featured: true,
  },
  {
